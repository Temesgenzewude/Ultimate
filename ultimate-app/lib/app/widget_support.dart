...
mixin AppWidget {
  ...
  static BottomNavigationBarItem createItemNav3(BuildContext context,
      String iconInactive, String iconActive, String label,
      {bool hasIntro = false, Color? iconColor}) {
    return BottomNavigationBarItem(
        activeIcon: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: iconColor, borderRadius: BorderRadius.circular(24)),
            ),
          ],
        ),
        icon: Image.asset(
