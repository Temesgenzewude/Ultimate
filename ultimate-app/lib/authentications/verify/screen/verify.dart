...
import 'package:flutter_ultimate/otp/otp_bloc.dart';
import 'package:flutter_ultimate/otp/otp_event.dart';
import 'package:flutter_ultimate/shared_preferences.dart';
                          ...
                          onPressed: _start != 0
                              ...
                              : () {
                                  context.read<OtpBloc>().add(OtpSent(
                                      prefManager.getPhoneNumber() as String));
                                  restartTimer();
                                },
