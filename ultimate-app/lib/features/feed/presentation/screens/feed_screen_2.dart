  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<NotificationSettingsBloc, NotificationSettingsState>(
        // listener: (context, notificationSettingState) {
        //   print('Stateeeeeeeeeeeee: $notificationSettingState');
        // },
        builder: (context, notificationSettingState) {
          print('Stateeeeeeeeeeeee: ${notificationSettingState.switchStates}');
          return CustomScrollView(
            slivers: [
              ...
              notificationSettingState.switchStates['adminNotification'] == true
                      ...
                      delegate: SliverChildBuilderDelegate(
                        ...
                        childCount:
                            _calculateAdminNotificationChildCount(context) > 2
                                ? 2
                                : _calculateAdminNotificationChildCount(
                                    context),
                      ),
                    )
              ...
              notificationSettingState.switchStates['newsNotification'] == true
                        ...
                        builder: (context, state) {
                          if (state is FeedLoadingState) {
                            ...
                            return Column(
                              children: [
                                const Text(
                                    "Sorry we couldn't load your feed now"),
                                TextButton(
                                  child: const Text('Retry'),
                                  onPressed: () {
                                    context
              ...
              // const SizedBox(height: 8),
              notificationSettingState.switchStates['messageNotification'] ==
                      true
                  ? SliverToBoxAdapter(
                      child: Builder(
                        builder: (context) {
